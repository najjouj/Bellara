...
class _CreateEtabScreenState extends State<CreateEtabScreen> {
  ...
  universitycallback(varSelectedNatEtab) {
    setState(() {
      selectedUniversity = varSelectedNatEtab;
    });
  }
  ...
  callbackGouv(varSelectedDeleg) {
    setState(() {
      selectedGouvernorat = varSelectedDeleg;
    });
  }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Gap(25),
                //**************************gouvernorat centre de formation********************** */

                if (selectedNature == natureTablissment[6])
                  const Padding(
                ...
                if (selectedNature == natureTablissment[6])
                  GestureDetector(
                    onTap: () {
                      Get.to(() => ListViewSearchScreen(
                          items: gouvernorats, stringCallback: callbackGouv));
                    },
                    child: Container(
                      height: 50,
                      alignment: Alignment.centerLeft,
                ...
                //universities search list **************************************************************//
                if (selectedNature == natureTablissment[0] ||
                    selectedNature == natureTablissment[1] ||
                    selectedNature == natureTablissment[2])
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: () {
                                  Get.to(() => ListViewSearchScreen(
                                      items: universities,
                                      stringCallback: universitycallback));
                                },
                                child: Container(
                                  height: 50,
                                  alignment: Alignment.centerLeft,
                ...
                //end of universities search list *****************************************************//

                if (selectedNature != natureTablissment[0] &&
                    selectedNature != natureTablissment[1] &&
                    selectedNature != natureTablissment[2] &&
                    selectedNature != natureTablissment[6])
                  const Padding(
                    padding: EdgeInsets.symmetric(
                      horizontal: 25,
                    ),
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (selectedNature == natureTablissment[0] ||
        ...
        setState(() {
          ...
          selectedNature = '';
          selectedUniversity = '';
          selectedTypeEtab = 'étatique';
          etatique = true;
          nameController.clear();
          descriptionController.clear();
        });
      } else if (selectedNature == natureTablissment[6]) {
        etabDBoperations().addEtabMF(
            selectedNature,
            selectedGouvernorat,
            selectedTypeEtab,
            nameController.text,
