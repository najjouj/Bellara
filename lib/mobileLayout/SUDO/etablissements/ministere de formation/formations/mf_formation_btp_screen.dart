...
class MFFormationBTPScreen extends StatelessWidget {
  final String gouvernorat;
  MFFormationBTPScreen({super.key, required this.gouvernorat});
            ...
            if (snapshot.data!.docs.isEmpty) {
              ...
              return StreamBuilder(
                stream: dbFormation()
                    ...
                    .where('diplome',
                        isEqualTo: 'Brevet de Technicien Professionnel')
                  ...
                  Expanded(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          print('hello');
                          print(gouv);
                          gouv = centres.contains(documents[index]['centre']);
                          ...
                          if (gouv)
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: [Text(documents[index]['diplome'])],
                              ),
                            );
                        }),
                  )
