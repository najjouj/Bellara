...
class MFFormationCAPScreen extends StatelessWidget {
  final String gouvernorat;
  MFFormationCAPScreen({super.key, required this.gouvernorat});
            ...
            if (snapshot.data!.docs.isEmpty) {
              ...
              return StreamBuilder(
                stream: dbFormation()
                    ...
                    .where('diplome',
                        isEqualTo: "Certificat d'Aptitude Professionnelle")
