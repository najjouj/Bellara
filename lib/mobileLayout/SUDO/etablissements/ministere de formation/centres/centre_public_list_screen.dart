...
class CentresPublicListScreen extends StatefulWidget {
  final String governorat;
  CentresPublicListScreen({super.key, required this.governorat});

  @override
  State<CentresPublicListScreen> createState() =>
      _CentresPublicListScreenState();
}

class _CentresPublicListScreenState extends State<CentresPublicListScreen> {
      ...
      return 
       ...
       StreamBuilder(
        stream: etabDBoperations()
            ...
            .doc('mf')
            .collection('centres de formations')
            .where('type', isEqualTo: 'étatique').where('gouvernorat',isEqualTo: widget.governorat)
            .snapshots(),
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            return const Center(
