...
class LyceeListScreen extends StatefulWidget {
  final String delegation;
  const LyceeListScreen({super.key, required this.delegation});

  @override
  State<LyceeListScreen> createState() => _LyceeListScreenState();
}

class _LyceeListScreenState extends State<LyceeListScreen> {
    ...
    if (widget.delegation == '')
      return StreamBuilder(
        stream: etabDBoperations()
            ...
            .where('nature', isEqualTo: 'Lycée secondaire')
            .snapshots(),
