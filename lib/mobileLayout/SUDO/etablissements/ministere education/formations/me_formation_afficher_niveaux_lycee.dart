...
class MEFormationAfficherNiveauxLycee extends StatelessWidget {
  MEFormationAfficherNiveauxLycee({super.key});
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: dbFormation()
          ...
          .where('cycle', isEqualTo: 'Enseignement secondaire')
          .where('niveau', whereIn: List.from(lycee))
          .snapshots(),
                    ...
                    return Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            const Gap(10),
                            MEFormationMatiereCard(niv: documents[index]['nom'],  )
                          ],
                        ));
                  }),
            );
