...
class EcolesPrimaireScolaireHomeScreen extends StatefulWidget {
  final String delegation;
  EcolesPrimaireScolaireHomeScreen({super.key, required this.delegation});

  @override
  State<EcolesPrimaireScolaireHomeScreen> createState() =>
      _EcolesPrimaireScolaireHomeScreenState();
}

class _EcolesPrimaireScolaireHomeScreenState
    extends State<EcolesPrimaireScolaireHomeScreen> {
    ...
    if (widget.delegation == '')
      return StreamBuilder(
        stream: etabDBoperations()
            ...
            .where('nature', isEqualTo: 'Ecole primaire')
            .snapshots(),
