...
import 'ms_formation_details.dart';

class MSFormationsEcolesScreen extends StatefulWidget {
  final String university;
  const MSFormationsEcolesScreen({super.key, required this.university});

  @override
  State<MSFormationsEcolesScreen> createState() =>
      _MSFormationsEcolesScreenState();
}

class _MSFormationsEcolesScreenState extends State<MSFormationsEcolesScreen> {
  @override
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        onTap: () => Get.to(() => MSFormationDetails(etab: documents[index]['etablissements'],
                              speciality: documents[index]['specialité'],
                            )),
                        child: Container(
                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                      color:
                                          Color.fromARGB(255, 187, 163, 228)),
                                  borderRadius: BorderRadius.circular(15)),
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.start,
                                crossAxisAlignment: CrossAxisAlignment.start,
