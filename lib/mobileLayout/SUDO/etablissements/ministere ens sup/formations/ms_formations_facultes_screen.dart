...
class MSFormationsFacultesScreen extends StatefulWidget {
  final String university;
  const MSFormationsFacultesScreen({super.key, required this.university});

  @override
  State<MSFormationsFacultesScreen> createState() =>
      _MSFormationsFacultesScreenState();
}

class _MSFormationsFacultesScreenState
    extends State<MSFormationsFacultesScreen> {
  @override
    ...
    if (widget.university != '')
      return StreamBuilder(
        stream: dbFormation()
            ...
            .where('formation', isEqualTo: "etudes d'ingenieurs")
            .snapshots(),
