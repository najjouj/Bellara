...
class AfficherEcolesScreen extends StatefulWidget {
  ...
  @override
  State<AfficherEcolesScreen> createState() => _AfficherEcolesScreenState();
}

class _AfficherEcolesScreenState extends State<AfficherEcolesScreen> {
    ...
    if (widget.university != '')
      return StreamBuilder(
        stream: etabDBoperations()
            ...
            .where('nature', isEqualTo: 'Ecole supérieur')
            .snapshots(),
