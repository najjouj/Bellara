...
class AfficherInstitusScreen extends StatefulWidget {
  final String university;
  const AfficherInstitusScreen({
    Key? key,
    required this.university,
  }) : super(key: key);

  @override
  State<AfficherInstitusScreen> createState() => _AfficherInstitusScreenState();
}

class _AfficherInstitusScreenState extends State<AfficherInstitusScreen> {
    ...
    if (widget.university != '')
      return StreamBuilder(
        stream: etabDBoperations()
            ...
            .where('nature', isEqualTo: 'Institut supérieur')
            .snapshots(),
