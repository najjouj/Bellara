...
class ProfileInfoEtudiant extends StatefulWidget {
  final String name;
  const ProfileInfoEtudiant({super.key, required this.name});

  @override
  State<ProfileInfoEtudiant> createState() => _ProfileInfoEtudiantState();
}

class _ProfileInfoEtudiantState extends State<ProfileInfoEtudiant> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Gap(15),
                        if (msNatureEtab.contains(natureEtabActuel))
                          Container(
                            //color: Colors.blue,
                            width: double.infinity,
                            height: 80,
                                ...
                                Container(
                                  ...
                                  child: StreamBuilder(
                                    stream: etabDBoperations()
                                        ...
                                        .where('etablissements',
                                            isEqualTo: actuelEtabName)
                                        .snapshots(),
                                    builder: (context, snapshot) {
                                      if (snapshot.connectionState ==
                                          ConnectionState.waiting) {
  ...
  void _updateInfo() {
    ...
    setState(() {
      logLoading = true;
      welcomeDBInfo().etudiantWelcomeInfo(
          uidUser,
          widget.name,
          avatarUrl,
          bannerUrl,
    ...
    etabDBoperations().etabAddEtudiant(uidUser, widget.name, niveau, speciality,
