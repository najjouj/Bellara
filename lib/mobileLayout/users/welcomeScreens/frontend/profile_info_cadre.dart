...
class ProfileInfoCadre extends StatefulWidget {
  final String name;
  const ProfileInfoCadre({super.key, required this.name});

  @override
  State<ProfileInfoCadre> createState() => _ProfileInfoCadreState();
}

class _ProfileInfoCadreState extends State<ProfileInfoCadre> {
  ...
  callbackNatureEtabActuel(varSelectedNatEtab) {
    setState(() {
      actuelNatureEtab = varSelectedNatEtab;
      if (meEtabsNature.contains(actuelNatureEtab)) {
        actuelMinistere = 'me';
      } else if (msEtabsNature.contains(actuelNatureEtab)) {
        actuelMinistere = 'ms';
      } else {
        actuelMinistere = 'mf';
      }
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                          ...
                          Container(
                            ...
                            child: StreamBuilder(
                              stream: etabDBoperations()
                                  ...
                                  .where('nature', isEqualTo: actuelNatureEtab)
                                  .snapshots(),
                        ...
                        if (msEtabsNature.contains(actuelNatureEtab))
                          Container(
                            //color: Colors.blue,
                            width: double.infinity,
                            height: 80,
                        ...
                        if (actuelNatureEtab == 'Centre de formation')
  ...
  void _updateInfo() {
    if (_formKey.currentState!.validate()) {
      ...
      setState(() {
        logLoading = true;
        welcomeDBInfo().cadreWelcomeInfo(uidUser, avatarUrl, bannerUrl,actuelMinistere,
            selectedRole, actuelEtabName, ecoleP, college, lycee, univetab);
        etabDBoperations().etabAddPersonnel(
            uidUser, widget.name, selectedRole, actuelMinistere,actuelEtabName);
